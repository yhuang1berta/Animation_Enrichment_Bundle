...
// // send textFall on request
// app.get('/textFall', (req, rest) => {
// 	res.sendFile("./pub/textFall.html", {root: __dirname})
// })

// // send spin on request
// app.get('/spinAndFloat', (req, res) => {
// 	res.sendFile("./pub/AEB.html")
// })

// // send bounce on request
// app.get('/bounceEffect', (req, res) => {
// 	res.sendFile("./pub/bounceEffect.html")
// })
